...
<section
  class="home-scroll-reveal"
  bind:this={sectionEl}
  style={`--section-height:${sectionHeight}vh;`}
  aria-label={alt}
>
  <div class="home-scroll-reveal__inner">
    <figure class="home-scroll-reveal__frame" bind:this={frameEl}>

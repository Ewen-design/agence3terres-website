...
<ProjectThemePage>
  <ProjectHeroProjetsStyle
    title="JustX Fitness"
    image={appPrimary}
    mobileImage={appSecondary}
    metaBlocks={[
      { label: "Date", value: "2026 - Present" },
      { label: "Produit", value: "Application mobile" },
      {
        label: "Services",
        value: ["Product design", "UX/UI", "Design system"]
      }
    ]}
    ctaLabel="Découvrir l'application"
    scrollToId="projet-en-cours"
  />

  <ProjectBrief
    lines={[
      "<span class='hl'>JustX Fitness</span> prolonge la marque JustX en une <span class='hl'>application mobile</span> pour planifier ses séances, suivre l'effort et mesurer sa progression.",
      "Chaque écran se concentre sur une action précise, dans un <span class='hl'>design system</span> cohérent qui garde l'<span class='hl'>identité</span> de la marque jusque dans le détail."
    ]}
    images={[
  ...
  <ProjectInProgress
    image={appPrimary}
    mobileImage={appSecondary}
    alt="Univers visuel de l'application JustX Fitness"
  />
</ProjectThemePage>

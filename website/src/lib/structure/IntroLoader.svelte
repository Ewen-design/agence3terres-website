...
<script>
  ...
  function updateLogoColor() {
    ...
    const sections = document.querySelectorAll(
      "section.creative-section, section.services, section.contact"
    );
